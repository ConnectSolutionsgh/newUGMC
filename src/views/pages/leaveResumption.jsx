...
const LeaveResumption = () => {
  ...
  return (
    <div>
      ...
      <Table className="table table-hover table-striped table-outline mb-0 d-none d-sm-table table-lg">
        <caption>Leave Resumptions</caption>
        <thead>
          <tr>
            <th></th>
            <th>Staff ID</th>
      ...
      >
        <CModalHeader closeButton>
          <CModalTitle>LEAVE MGT | LEAVE RESUMPTION </CModalTitle>
        </CModalHeader>
        <CModalBody className="modal-body">
          <form className="row g-3">
            <CInputGroup className="mt-3">
              <CLabel htmlFor="staffId" className="col-sm-3">
                Staff ID *
              </CLabel>
...
export default LeaveResumption
